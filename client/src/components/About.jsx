function About() {
  return (
    ...
    <div id="about" className="about-container">
      <p>
        I’m a developer with a strong foundation in C#/.NET, JavaScript, React,
        and SQL, driven by a passion for solving problems and building clean,
        functional applications. My journey into tech started after 15 years in
        the industrial world, where I worked in electrical maintenance and
        controls. That background taught me how to troubleshoot, think
        systematically, and stay calm under pressure — skills I now apply to
      ...
      <p>
        ...
        bug tracker, a timekeeping filter tool for Excel, and an AI-powered book
        recommendation app concept.
      </p>
      <p>
